...
class AstBuilder extends SqlBaseBaseVisitor<Node> {
        ...
        if (term instanceof QuerySpecification) {
            ...
            return new Query(
                ...
                new DiffQuerySpecification(
                    ...
                    Optional.of(diffQuery.getMinTrendDiffExpression()),
    ...
    @Override
    public Node visitMinTrendDiffExpression(SqlBaseParser.MinTrendDiffExpressionContext context) {
        return new MinTrendDiffScoreExpression(getLocation(context),
                new DecimalLiteral(context.minTrendDiff.getText()));
    }
    ...
    public Node visitDiffQuerySpecification(SqlBaseParser.DiffQuerySpecificationContext context) {
        ...
        Optional<MinTrendDiffScoreExpression> minTrendDiffExpr = visitIfPresent(
                context.minTrendDiffExpression(),
                MinTrendDiffScoreExpression.class);
