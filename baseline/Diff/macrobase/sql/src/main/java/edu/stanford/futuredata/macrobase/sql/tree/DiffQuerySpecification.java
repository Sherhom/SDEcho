...
public class DiffQuerySpecification extends QueryBody {
    ...
    private final MinTrendDiffScoreExpression minTrendDiffScoreExpr;
    ...
    private static final MinTrendDiffScoreExpression DEFAULT_MIN_TREND_DIFF_SCORE_EXPRESSION
            = new MinTrendDiffScoreExpression(new DecimalLiteral("100000.0"));
    ...
    public boolean isTrendDiff(){
        return minTrendDiffScoreExpr.getMinTrendDiffScore() < 0;
    }
    ...
    public DiffQuerySpecification(
        ...
        this(Optional.empty(), select, first, second, splitQuery, attributeCols, minRatioExpr,Optional.empty(),
    ...
    public DiffQuerySpecification(
        ...
        List<Identifier> attributeCols,
        Optional<MinRatioExpression> minRatioExpr,
        Optional<MinTrendDiffScoreExpression> minTrendDiffScoreExpr,
        Optional<MinSupportExpression> minSupportExpr,
        Optional<RatioMetricExpression> ratioMetricExpr,
        Optional<IntLiteral> maxCombo,
        Optional<Expression> where,
        ...
        Optional<String> limit,
        Optional<ExportClause> exportExpr) {
        this(Optional.of(location), select, first, second, splitQuery, attributeCols, minRatioExpr, minTrendDiffScoreExpr,
            minSupportExpr, ratioMetricExpr, maxCombo, where, orderBy, limit, exportExpr);
    }
    ...
    private DiffQuerySpecification(
        ...
        this.minTrendDiffScoreExpr = minTrendDiffScoreExpr.orElse(DEFAULT_MIN_TREND_DIFF_SCORE_EXPRESSION);
    ...
    public MinTrendDiffScoreExpression getMinTrendDiffExpression(){
        return minTrendDiffScoreExpr;
    }
