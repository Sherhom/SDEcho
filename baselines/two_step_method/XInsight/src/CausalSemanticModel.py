...
class Edge:
    ...
    def __init__(self, start: str, end: str, edge_type) -> None:
        if type(edge_type) == Edge.EdgeType:
            self.edge_type = edge_type
        else:
            if edge_type == 1:
                self.edge_type = Edge.EdgeType.Direct
            elif edge_type == 2: 
                self.edge_type = Edge.EdgeType.SemiDirect
            elif edge_type == 3:
                self.edge_type = Edge.EdgeType.BiDirect
            elif edge_type == 4:
                self.edge_type = Edge.EdgeType.NonDirect
