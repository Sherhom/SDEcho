...
public:
	...
	bool isRecordOfExp(int index, vector<int>& exp);

	//compute the actual score of the explanation
	double computeAcutalScore(vector<int>& explanation,SubVec& d0);
	double computeAcutalScore(vector<int>& explanation, SubVec& d0,int ltime,int rtime);
};