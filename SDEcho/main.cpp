...
string groupbyColName;			//name of groupby column
...
int main(int argc,char* argv[]) {
	...
	Trendiff trendiff(conn,groupbyColName,aggColName,focusColNames,aggFunc,table1Name,table2Name);
	...
	cout << "[LOGGING ] PATH : " << QueryCfg_path << " k: " <<  k  << " order :" << order_int << endl;	
	cout << "=================================" << endl;
